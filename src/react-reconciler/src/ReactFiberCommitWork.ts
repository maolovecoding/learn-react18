...
const recursivelyTraverseLayoutEffects = (
  root: FiberRootNode,
  parentFiber: FiberNode
) => {
  if ((parentFiber.subtreeFlags & LayoutMask) !== NoFlags) {
    let child = parentFiber.child;
    while (child !== null) {
